...
MODULE CLOUDSC_DRIVER_GPU_ACC_SCC_V2_MOD
  ...
  USE CLOUDSC_GPU_ACC_SCC_V2_MOD, ONLY: CLOUDSC_SCC,global_var
...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    gv%RTICE=RTICE
    gv%RTICECU=RTICECU
    gv%RTWAT_RTICE_R=RTWAT_RTICE_R
    gv%RTWAT_RTICECU_R=RTWAT_RTICECU_R
    gv%RKOOP1=RKOOP1
    gv%RKOOP2=RKOOP2
    gv%NCLDQV=NCLDQV
    gv%NCLDQL=NCLDQL
...
END MODULE CLOUDSC_DRIVER_GPU_ACC_SCC_V2_MOD
